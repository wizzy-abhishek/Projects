...
<nav class="navbar navbar-expand-lg navbar-light bg-light w-100">
  <div class="container-fluid">
    <a class="navbar-brand">Modify Details</a>
...
<div class="left-column">
    ...
    <img src="HANDSHAKE_LOGO.png" alt="IMAGE" height="300" width="300" >
    </div>
    
    
    <form action="Modified" method="post">
    	<div class="form-group">
            <input type="text" name="Provided_number" placeholder=" &nbsp Give the provided number " required style="width: 310px; height: 45px; margin: 0 auto;">
        </div>
        <div class="form-group">
            <input type="text" name="New_Domain" placeholder=" &nbsp Domain like Insta/FB" required style="width: 310px; height: 45px; margin: 0 auto;">
        </div>
        <div class="form-group">
            <input type="text" name="New_UserId_of_Domain" placeholder=" &nbsp NEW USER_ID like ab@12" required  style="width: 310px; height: 45px; margin: 0 auto;">
        </div>
        <div class="form-group">
            <input type="text" name="New_Password_of_User_ID" placeholder=" &nbsp NEW PASSWORD OF THE ID" required  style="width: 310px; height: 45px; margin: 0 auto;">
        </div>
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-sm"  style="width: 310px; height: 45px; margin: 0 auto;">UPDATE</button>
        </div>
    </form>
</div>
<hr>
