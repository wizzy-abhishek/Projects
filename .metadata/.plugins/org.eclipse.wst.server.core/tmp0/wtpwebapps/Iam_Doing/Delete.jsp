...
<div class="left-column">
    ...
    <img src="Delete.png" alt="Website Logo" height="300" width="300" >
    </div>
    
    
    <form action="Deleted" method="post">
        <div class="form-group">
            <input type="text" name="Provided_number" placeholder=" &nbsp Give the provided number " required style="width: 310px; height: 45px; border-radius : 10px ; margin: 10px auto;">
        </div>
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-sm"  style="width: 310px; height: 45px; margin: 0 auto; border-radius : 10px ; ">DELETE</button>
        </div>
    </form>
</div>
<hr>
