    ...
    <div class="form-container text-center">
      <form action="Creating" method="post">
        ...
        <div class="mb-3 position-relative">
          <input name="userID" type="text" class="form-control" id="text" placeholder="Create UNIQUE id" required style="width: 250px; margin: 0 auto;"> 
        </div>
        ...
        <br>
         ...
         <BR>
         <p> YOUR DATA IS END TO END ENCRYPTED</p> <H5></H5> * YOUR ID SHOULD BE UNIQUE SO PLEASE PROVIDE YOU MOBILE NUMBER OR ANY UNIQUE ID 
  </div>
</div>
